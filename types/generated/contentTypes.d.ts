  ...
  attributes: {
    blocks: Schema.Attribute.DynamicZone<
      [
        'home.home-wallet',
        'home.home-navbar',
        'home.home-device-types',
        'home.home-notification-banner',
      ]
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    device_type: Schema.Attribute.Relation<
      ...
      'api::device-type.device-type'
    >;
    expense: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    face_value: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
    ...
    provider_cut: Schema.Attribute.Decimal &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
